...
import ClientDashboardPage from "./components/ClientDashboardPage.jsx";
import {
  buildShareUrl,
  createClientShare,
  getShareModeFromUrl,
        ...
        return (
          <>
            ...
            >
              ...
              >
                <h1 style={px({ color: "#00215D", marginTop: 0 })}>הקישור לא זמין</h1>

                <p style={px({ color: "#627D98", lineHeight: 1.8 })}>{shareError.value}</p>

                <p style={px({ color: "#627D98", lineHeight: 1.8, fontSize: 13 })}>
