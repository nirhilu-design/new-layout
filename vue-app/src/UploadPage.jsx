...
export default defineComponent({
  ...
  setup(props) {
    ...
    const section28CappingUploads = ref([
    ...
    const updateRecognizedPensionOwner = (owner) => {
      ...
      const prev = vestedPdfTable.value;
      vestedPdfTable.value = prev
        ? {
            ...prev,
            owner: safeOwner,
    ...
    const addCapitalClassificationUpload = () => {
      capitalClassificationUploads.value = [
        ...capitalClassificationUploads.value,
        {
          ...
          owner: capitalClassificationUploads.value.some((item) => item.owner === "spouseA") ? "spouseB" : "spouseA",
        },
      ];
    };
    ...
    const addSection28CappingUpload = () => {
      section28CappingUploads.value = [
        ...
        createSection28CappingUpload(
          section28CappingUploads.value.some((item) => item.owner === "spouseA") ? "spouseB" : "spouseA"
        ),
      ];
    };
    ...
    const handleAnalyzeFiles = async () => {
      try {
        ...
        reportData.recognizedPensionOwnerLabel =
          getFamilyOwnerLabel(recognizedPensionOwner.value);
        ...
        >
            ...
            >
              <div>
                ...
                {clientLogoFile.value && (
                  ...
                  >
                    נבחר לוגו: {clientLogoFile.value.name}
                  </div>
                )}
              ...
              >
                <div
                  style={{
                    ...
                    background: clientLogoPreview.value ? "#ffffff" : "#eef2fa",
                    display: "flex",
                    alignItems: "center",
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {section28CappingUploads.value.map((item, index) => {
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={section28CappingUploads.value.length <= 1 || item.loading}
                          style={{
                            background:
                              section28CappingUploads.value.length <= 1 || item.loading
                                ? "#f4f6fb"
                                : "#fff5f5",
                            color:
                              section28CappingUploads.value.length <= 1 || item.loading
          ...
          >
            ...
            >
              <div>
                ...
                >
                  <select
                    value={recognizedPensionOwner.value}
                    onChange={(event) =>
                  ...
                  >
                    שיוך קצבה מוכרת: ה־PDF וההזנות הידניות בריבוע זה יישמרו עבור {getFamilyOwnerLabel(recognizedPensionOwner.value)}.
                  </div>
                </div>
                ...
                {vestedPdfFile.value && (
                  ...
                  >
                    קובץ PDF: {vestedPdfFile.value.name} · שייך ל{getFamilyOwnerLabel(recognizedPensionOwner.value)}
                  </div>
                )}

                {vestedPdfTable.value?.rows?.length ? (
                  <div
                    style={{
                      color: "#247a3d",
                      fontSize: 12,
                  ...
                  >
                    נמצאו {vestedPdfTable.value.rows.length} שורות בטבלה
                  </div>
                ) : null}
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {recognizedPensionAdjustments.value.map((item) => (
                      <div
                        key={item.id}
                        style={{
                          display: "grid",
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={recognizedPensionAdjustments.value.length <= 1}
                          style={{
                            height: 42,
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: 18,
                    border: "1px solid #d7deed",
                    background: vestedPdfTable.value?.rows?.length ? "#eefaf1" : "#eef2fa",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    overflow: "hidden",
                    color: vestedPdfTable.value?.rows?.length ? "#247a3d" : "#7b879d",
                    fontSize: 13,
                    fontWeight: 800,
                    textAlign: "center",
                    padding: 8,
                ...
                >
                  <button
                    ...
                    disabled={vestedPdfLoading.value}
                    style={{
                      background: "#ffffff",
                      color: "#0d2c6c",
                      border: "1px solid #cbd4e6",
                      ...
                      fontSize: 12,
                      fontWeight: 800,
                      cursor: vestedPdfLoading.value ? "not-allowed" : "pointer",
                      minWidth: 120,
                    }}
                  >
                    בחירת PDF
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {capitalClassificationUploads.value.map((item, index) => {
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={capitalClassificationUploads.value.length <= 1 || item.loading}
                          style={{
                            background:
                              capitalClassificationUploads.value.length <= 1 || item.loading
                                ? "#f4f6fb"
                                : "#fff5f5",
                            color:
                              capitalClassificationUploads.value.length <= 1 || item.loading
          ...
          <div
            ...
            style={{
              border: isDragging.value ? "2px solid #0d2c6c" : "2px dashed #cbd4e6",
              background: isDragging.value ? "#eef4ff" : "#f9fbff",
              borderRadius: 24,
              padding: "34px 24px",
              textAlign: "center",
          ...
          >
            ...
            >
              {selectedFiles.value.length
                ? `נבחרו ${selectedFiles.value.length} קבצים`
              ...
              {selectedFiles.value.map((file, index) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "14px 16px",
                    borderBottom:
                      index !== selectedFiles.value.length - 1
                        ? "1px solid #eef2fa"
                        : "none",
                  }}
                >
          ...
          <button
            ...
            disabled={loading.value || selectedFiles.value.length === 0}
            style={{
              width: "100%",
              padding: "16px 20px",
              background:
                loading.value || selectedFiles.value.length === 0 ? "#c3cbdd" : "#0d2c6c",
              color: "#fff",
              border: "none",
              borderRadius: 16,
              fontSize: 12,
              fontWeight: 800,
              cursor:
                loading.value || selectedFiles.value.length === 0 ? "not-allowed" : "pointer",
              transition: "all 0.2s ease",
            }}
          >
            {loading.value ? "מנתח קבצים..." : "הפק דוח"}
          </button>
